...
from main_app.views import post_views, post_create, post_detail, comment, contact_us, like, report, that_movie, \
    report_post, follow, delete_post, edit_post, delete_comment, movie, search_movie
...
urlpatterns = [
    ...
    path('filmler/<movie_name>', movie, name="movie"),
